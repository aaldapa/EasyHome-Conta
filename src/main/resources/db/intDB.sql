INSERT INTO `users` (`id_user`, `cuenta_no_expirada`, `cuenta_no_bloqueada`, `apellido1`, `apellido2`, `credencial_no_expirada`, `activo`, `nombre`, `password`, `username`, fecha_creacion)
VALUES(1, 1, 1, 'Cuesta', 'Gutiérrez', 1, 1, 'Alberto', '123', 'Alberto', '2015-03-01');
